...
for count in range(ring_osc_subckt_count):
    ...
    file_path_name = 'F:/Google Drive/_UMASS/18 - Fall 2022/EECE 5500 ADSD/ngspice64/bin/' + file_name
...
filename = 'F:/Google Drive/_UMASS/18 - Fall 2022/EECE 5500 ADSD/ngspice64/bin/run_ring_osc.cir'
